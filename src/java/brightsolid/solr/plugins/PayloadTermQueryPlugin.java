...
public class PayloadTermQueryPlugin extends QParserPlugin {
  ...
  public QParser createParser(String qstr, SolrParams localParams, SolrParams params, SolrQueryRequest req) {
    return new QParser(qstr, localParams, params, req) {
      public Query parse() {
        return new PayloadTermQuery(new Term(localParams.get(QueryParsing.F), localParams.get(QueryParsing.V)),
                createPayloadFunction(localParams.get("mult"), localParams.get("posn")), false);
      }
    };
  }
